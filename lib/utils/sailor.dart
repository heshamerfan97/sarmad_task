...
extension NavigationMethods on _SailorImpl {
  ...
  String? currentName() => currentContext==null?null:ModalRoute.of(currentContext!)?.settings.name;
  ...
  Future<dynamic> makeFirst(String routeName, {Object? args}) {
    return _navigatorKey.currentState!.pushNamedAndRemoveUntil(routeName, (Route<dynamic> route) => false);
  }

  static BuildContext? currentContext = Sailor.navigatorKey.currentState?.overlay?.context;
